    ...
    <section className="landing-hero">
      ...
      <div className="landing-container relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-neutral-400 mb-8">
          ...
          <span>Tools</span>
          <span>&gt;</span>
          <span className="text-primary font-medium">Clip Maker</span>
        </div>
        ...
        <div className="landing-hero-content">
          ...
          >
            {/* Credit Badge */}
            <motion.div 
              className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-xs font-semibold text-primary mb-6"
              variants={fadeUp}
            ...
            <motion.h1 className="landing-hero-title font-extrabold tracking-tight mb-4" variants={fadeUp} transition={tween(0.55)}>
              AI Clip Maker - <span className="text-gradient">Turn Videos Into Viral Clips</span>
            </motion.h1>

            <motion.p className="landing-hero-sub text-neutral-400 max-w-3xl mb-8" variants={fadeUp} transition={tween(0.5)}>
              Transform any video into viral-ready clips with AI. The best <span className="text-primary font-bold">FREE</span> clip maker and ai clip generator to create attention-grabbing shorts for TikTok, Instagram, and YouTube in seconds—no experience required.
            </motion.p>
          </motion.div>
          ...
          >
            <form className="w-full flex items-center gap-2 p-1.5 rounded-full border border-primary/40 bg-neutral-950/80 shadow-lg shadow-primary/5 focus-within:border-primary/80 transition-all duration-300" onSubmit={handleSubmit}>
              ...
              />
              <button type="submit" className="h-10 w-10 md:h-11 md:w-11 rounded-full bg-primary hover:bg-primary-hover text-white flex items-center justify-center transition-all duration-200 shrink-0 shadow-md shadow-primary/20">
            ...
            {/* Social Icons row */}
            <div className="flex flex-wrap items-center justify-center gap-4 mt-4 opacity-75">
              {/* YouTube */}
              <div className="w-8 h-8 rounded-full bg-red-600/10 flex items-center justify-center text-red-500 border border-red-500/20">
              ...
              {/* TikTok */}
              <div className="w-8 h-8 rounded-full bg-neutral-900 flex items-center justify-center text-white border border-neutral-800">
              ...
              {/* Twitch */}
              <div className="w-8 h-8 rounded-full bg-purple-600/10 flex items-center justify-center text-purple-400 border border-purple-500/20">
              ...
              <div className="w-8 h-8 rounded-full bg-sky-500/10 flex items-center justify-center text-sky-400 border border-sky-500/20">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M22.396 7.177c-.074 1.702-1.252 4.026-3.535 6.972-2.366 3.064-4.364 4.594-5.992 4.594-.999 0-1.848-.921-2.548-2.766-.47-1.722-.94-3.444-1.41-5.166-.515-1.868-1.066-2.803-1.653-2.803-.118 0-.53.243-1.236.728l-.735-.941c.765-.676 1.523-1.353 2.278-2.029 1.03-.897 1.802-1.369 2.316-1.413 1.206-.103 1.949.721 2.229 2.472.31 1.93.522 4.126.639 6.591.161 1.722.5 2.583 1.015 2.583.397 0 1.008-.633 1.834-1.897.828-1.264 1.272-2.22 1.332-2.868.118-1.133-.235-1.701-1.059-1.701-.397 0-.809.088-1.235.265 1.558-5.097 5.753-4.708 7.027-.39z"/></svg>
              </div>
              {/* Facebook */}
              <div className="w-8 h-8 rounded-full bg-blue-600/10 flex items-center justify-center text-blue-500 border border-blue-500/20">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </div>
              {/* Google Drive */}
              <div className="w-8 h-8 rounded-full bg-green-600/10 flex items-center justify-center text-green-500 border border-green-500/20">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M7.71 3.5L1.15 15l3.28 5.7h13.12l3.28-5.7L14.29 3.5H7.71zm.88.9h6.82l5.72 10-3.41 5.9H6.29l-3.4-5.9 5.7-10z"/></svg>
              </div>
              {/* Dropbox */}
