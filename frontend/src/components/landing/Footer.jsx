  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-hidden="true">
        <path d="M23.498 6.163a3.003 3.003 0 0 0-2.11-2.107C19.524 3.545 12 3.545 12 3.545s-7.525 0-9.388.511a3.002 3.002 0 0 0-2.11 2.107C0 8.028 0 12 0 12s0 3.972.502 5.837a3.002 3.002 0 0 0 2.11 2.107C4.475 20.455 12 20.455 12 20.455s7.525 0 9.388-.511a3.002 3.002 0 0 0 2.11-2.107C24 15.972 24 12 24 12s0-3.972-.502-5.837zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
      </svg>
    ),
  },
  {
      ...
      <div className="landing-container">
        <div className="landing-footer-top">
          <div className="landing-footer-brand">
            ...
            <p className="landing-footer-tagline">
              Turn long-form YouTube videos into viral short-form clips with AI —
              built for creators who ship every day.
            </p>
          </div>
        ...
        <div className="landing-footer-bottom">
          <p className="landing-footer-copy">
            &copy; {new Date().getFullYear()} ClipMantra Inc. All rights reserved.
          </p>
