...
const NewJobPage = ({ onJobCreated, toast }) => {
  ...
  return (
    <div style={{ maxWidth: 600 }} className="flex flex-col gap-lg">
      ...
      <div className="card" style={{ padding: "32px" }}>
        ...
        <div style={{
          ...
          <p style={{ color: "#333", fontSize: 10, fontFamily: "'DM Mono', monospace", letterSpacing: 1.5, textTransform: "uppercase", margin: "0 0 16px" }}>
            Pipeline
          </p>
            ...
            {steps.map(([title, desc], i) => (
              <div key={title} className="flex gap-md">
                ...
                <div style={{ paddingBottom: i < steps.length - 1 ? 16 : 0 }}>
                  <p className="font-syne" style={{ color: "#fff", fontSize: 13, fontWeight: 700, margin: "0 0 2px" }}>{title}</p>
                  <p style={{ color: "#555", fontSize: 11, fontFamily: "'DM Mono', monospace", margin: 0 }}>{desc}</p>
                </div>
              </div>
            ))}
          </div>
